...
struct Action : public apt::ActionBase<DGrid> {
 private:
  bool _orig_EB = true;  // this will tell the simulator to restore values in
                         // overlapping areas before applying this action

 public:
  Action& require_original_EB(bool x) {
    _orig_EB = x;
    return *this;
  }
  ...
  virtual void operator()(Field<Real, 3, DGrid>& E, Field<Real, 3, DGrid>& B,

...
namespace field {
  ...
  public:
    ...
    constexpr auto& set_op_inv_precision(int n) noexcept {_op_inv_precision = n; return *this;}
    constexpr auto& set_alpha(R a) noexcept {_alpha = a; return *this;}
    constexpr auto &set_surface(R a) noexcept {_surface = a; return *this;}
    constexpr auto &set_outer(R a) noexcept {_outer = a; return *this;}

    virtual LogSphericalSolver* Clone() const { return new LogSphericalSolver(*this); }

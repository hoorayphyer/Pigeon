...
template void annihilate<DGrid, real_t, Specs, ShapeF, real_j_t>(
    ...
    field::Field<real_j_t, 3, DGrid>& J, real_t charge_el, real_t charge_po,
    const apt::Grid<real_t, DGrid>& grid, const mpi::Comm& intra, real_t dt,
    const ShapeF&, real_t (*)(real_t, real_t),

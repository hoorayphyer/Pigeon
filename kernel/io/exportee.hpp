...
struct PtcExportee : public ExporteeBase {
  virtual field::Field<RDS, 3, DGrid> action(
      const int ds_ratio, const apt::Grid<R, DGrid>& grid,  // local grid
      const apt::Grid<RDS, DGrid>& grid_ds,  // grid of downsampled field
